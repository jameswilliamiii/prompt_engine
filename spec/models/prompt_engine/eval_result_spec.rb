...
RSpec.describe PromptEngine::EvalResult, type: :model do
  ...
  describe 'scopes' do
    ...
    describe '.passed' do
      it 'returns only passed results' do
        results = PromptEngine::EvalResult.passed
    ...
    describe '.failed' do
      it 'returns only failed results' do
        results = PromptEngine::EvalResult.failed
  ...
  describe 'data storage' do
    ...
    it 'defaults passed to false' do
      result = PromptEngine::EvalResult.new(
        eval_run: eval_run,
        test_case: test_case
      )
