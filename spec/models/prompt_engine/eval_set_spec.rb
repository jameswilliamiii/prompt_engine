...
RSpec.describe PromptEngine::EvalSet, type: :model do
  ...
  describe "scopes" do
    ...
    describe ".by_name" do
      it "orders eval sets by name" do
        expect(PromptEngine::EvalSet.by_name).to eq([eval_set1, eval_set2, eval_set3])
      end
    end
    ...
    describe ".with_test_cases" do
      it "includes test cases" do
        ...
        result = PromptEngine::EvalSet.with_test_cases.first
  ...
  describe "instance methods" do
    ...
    describe "#latest_run" do
      it "returns the most recent eval run" do
        create(:eval_run, eval_set: eval_set, created_at: 2.days.ago)
    ...
    describe "#openai_eval_id persistence" do
      it "can store and retrieve openai_eval_id" do
        ...
        reloaded = PromptEngine::EvalSet.find(eval_set.id)
