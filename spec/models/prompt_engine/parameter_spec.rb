...
RSpec.describe PromptEngine::Parameter, type: :model do
  describe "validations" do
    ...
    context "name validation" do
      ...
      it "validates uniqueness of name scoped to prompt" do
        create(:parameter, name: "user_name", prompt: prompt)
    ...
    context "parameter_type validation" do
      ...
      it "validates inclusion in TYPES" do
        PromptEngine::Parameter::TYPES.each do |valid_type|
  ...
  describe "associations" do
    it "belongs to prompt" do
      association = PromptEngine::Parameter.reflect_on_association(:prompt)
  ...
  describe "scopes" do
    ...
    describe ".required" do
      it "returns only required parameters" do
        expect(PromptEngine::Parameter.required).to contain_exactly(required_param1, required_param2)
      end
    end

    describe ".optional" do
      it "returns only optional parameters" do
        expect(PromptEngine::Parameter.optional).to contain_exactly(optional_param1, optional_param2)
      end
    end
  ...
  describe "callbacks" do
    describe "before_validation" do
      it "sets default parameter_type to string" do
        parameter = PromptEngine::Parameter.new(name: "test", prompt: create(:prompt))
        parameter.valid?
      ...
      it "does not override existing values" do
        parameter = PromptEngine::Parameter.new(
          name: "test",
