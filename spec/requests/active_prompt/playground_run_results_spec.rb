...
module ActivePrompt
  RSpec.describe "PlaygroundRunResults", type: :request do
    ...
    describe "GET /active_prompt/playground_run_results/:id" do
    ...
    describe "GET /active_prompt/prompts/:prompt_id/playground_run_results" do
      it "returns a successful response" do
    ...
    describe "GET /active_prompt/prompts/:prompt_id/versions/:version_id/playground_run_results" do
      it "returns a successful response" do
