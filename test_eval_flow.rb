...
puts "Testing PromptEngine Eval Flow"
puts "=" * 50

# Find or create a test prompt
prompt = PromptEngine::Prompt.find_or_create_by!(name: "Test Classifier") do |p|
...
puts "\n" + "=" * 50
puts "View results at: http://localhost:3000/prompt_engine/prompts/#{prompt.id}/eval_runs/#{eval_run.id}"
